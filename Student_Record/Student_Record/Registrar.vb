...
Public Class Registrar
    Public Shared registView

    Dim con As New OleDbConnection
    Dim command As New OleDbDataAdapter
    Private Sub Registrar_Load(sender As Object, e As EventArgs) Handles MyBase.Load 'TODO: This line of code loads data into the 'STUDENT_RECORDDataSet.Member' table. You can move, or remove it, as needed.
    ...
    Private Sub updateBttn_Click(sender As Object, e As EventArgs) Handles updateBttn.Click
        ...
        If idlbl.Text = "1" Then
            MessageBox.Show("Cannot Edit the Admin!", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error)
        Else
